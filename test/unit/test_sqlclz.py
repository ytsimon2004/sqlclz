...
import sqlp
from sqlp import named_tuple_table_class, PRIMARY, Connection, check, foreign
...
class SqlpTableTest(unittest.TestCase):
    ...
    def test_foreign_field(self):
        from sqlp.table import table_foreign_field, ForeignConstraint
    ...
    def test_map_foreign(self):
        from sqlp.util import map_foreign
    ...
    def test_pull_foreign(self):
        from sqlp.util import pull_foreign
