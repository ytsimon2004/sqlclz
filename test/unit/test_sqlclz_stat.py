...
import sqlclz
from sqlclz import named_tuple_table_class, foreign, check
...
class SqlpStatTest(unittest.TestCase):
    ...
    def test_create_table(self):
        ...
        stat, par = sqlclz.create_table(Test).build()
    ...
    def test_select_from(self):
        stat, par = sqlclz.select_from(Test).build()
        self.assert_sql_state_equal("""
        SELECT * FROM Test
        """, stat)
        self.assertListEqual([], par)
    ...
    def test_select_from_fields(self):
        stat, par = sqlclz.select_from(Test.a).build()
        self.assert_sql_state_equal("""
        SELECT Test.a FROM Test
        """, stat)
        self.assertListEqual([], par)

        stat, par = sqlclz.select_from(Test.a, Test.b).build()
        self.assert_sql_state_equal("""
    ...
    def test_select_from_where(self):
        stat = sqlclz.select_from(Test).where(
            Test.a == 1
        )
    ...
    def test_select_from_limit(self):
        stat = sqlclz.select_from(Test).limit(10)
    ...
    def test_select_from_limit_offset(self):
        stat = sqlclz.select_from(Test).limit(10, 2)
    ...
    def test_select_from_order_by(self):
        stat = sqlclz.select_from(Test).order_by(Test.a)
    ...
    def test_select_from_order_by_asc(self):
        stat = sqlclz.select_from(Test).order_by(
            sqlclz.asc(Test.a), sqlclz.desc(Test.b)
        )
    ...
    def test_insert_into(self):
        stat, par = sqlclz.insert_into(Test).build()
    ...
    def test_insert_into_or_replace(self):
        stat, par = sqlclz.insert_into(Test, policy='REPLACE').build()
    ...
    def test_insert_into_named(self):
        stat, par = sqlclz.insert_into(Test, named=True).build()
    ...
    def test_insert_into_named_overwrite_keyword(self):
        stat, par = sqlclz.insert_into(Test, named=True).values(
            b=sqlclz.max(10, ':b')
        ).build()
    ...
    def test_insert_into_partial(self):
        stat, par = sqlclz.insert_into(Test.b).build()
    ...
    def test_insert_into_constant_value(self):
        stat, par = sqlclz.insert_into(Test.a, Test.b).values(
            Test.b == 1
        ).build()
    ...
    def test_insert_into_from_select(self):
        ...
        stat, par = sqlclz.insert_into(Test).select_from(Other).build()
        self.assert_sql_state_equal("""
    ...
    def test_update_key_value(self):
        stat = sqlclz.update(Test, b=1, c=2)
    ...
    def test_update_field(self):
        stat = sqlclz.update(Test, Test.b == 1, Test.c == 3)
    ...
    def test_update_field_where(self):
        stat = sqlclz.update(Test, Test.b == 1).where(Test.a == '1')
    ...
    # TODO sqlclz.delete_from

    def test_alias(self):
        stat = sqlclz.select_from(
            Test.a @ 'x',
            Test.b @ 'y',
        )
    ...
    def test_table_alias(self):
        ...
        t = sqlclz.alias(Test, 't')

        stat = sqlclz.select_from(t.name)
        res, par = stat.build()
        self.assert_sql_state_equal("""
    ...
    def test_over_window_func_over(self):
        stat = sqlclz.select_from(
            Test.a,
            Test.b,
            sqlclz.row_number().over(order_by=Test.b)
        )
        res, par = stat.build()
        self.assert_sql_state_equal("""
        SELECT
    ...
    def test_over_window_func_partition_by(self):
        stat = sqlclz.select_from(
            Test.a,
            Test.b,
            sqlclz.row_number().over(partition_by=Test.b)
        )
    ...
    def test_over_window_func_frame(self):
        w = sqlclz.window_def('w').over(order_by=Test.a)
    ...
    def test_join(self):
        @sqlclz.named_tuple_table_class
        class Other(NamedTuple):
            c: Annotated[str, sqlclz.PRIMARY]
            d: int
